...
extern int32_t ya_hal_os_mutex_get(ya_hal_os_mutex_t *mhandle, uint32_t mses);

extern int32_t ya_hal_os_mutex_put(ya_hal_os_mutex_t *mhandle);

extern void ya_hal_os_mutex_delete(ya_hal_os_mutex_t *mhandle);
#endif
